...
const DialogueSearch_1 = require("./DialogueSearch");
const dialogue1 = new DialogueSearch_1.Dialogue();
dialogue1.character = "Tom";
dialogue1.line = "Hey, Bob, Alice is coming to join us";
const dialogue2 = new DialogueSearch_1.Dialogue();
dialogue2.character = "Bob";
dialogue2.line = "Hey, Tom, where's aliceee coming from";
const dialogue3 = new DialogueSearch_1.Dialogue();
dialogue3.character = "Tom";
dialogue3.line = "alice came from Chris's place";
const movie1 = new DialogueSearch_1.Movie();
movie1.setDialogue([dialogue1, dialogue2, dialogue3]);
const dialogueSearch = new DialogueSearch_1.DialogueSearch();
