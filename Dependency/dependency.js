...
class Package {
    ...
    get_dependencies() {
        ...
        this.dependencies.forEach((dependency) => {
            const package_denpendency = new Package(dependency.name, dependency.version);
            const dependency_packages = package_denpendency.install();
            dependency_packages.forEach((pack) => {
                const find_index = result.findIndex((existing_pack) => existing_pack.name === pack.name &&
    ...
    install() {
        ...
        const find_index = all_dependencies.findIndex((existing_pack) => existing_pack.name === this.name &&
